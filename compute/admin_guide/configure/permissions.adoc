...
---------------------------
Comments by Pasquale Russiello: Hi guys, the following permission is missing in the first table secretsmanager:GetSecretValue
Additionally, I'd like to request an important enhancement (IMHO): Could we please add the column "Removal" to the first table, identically to what we've done for agentless to indicate what happens if a specific permission is missing?
Many thanks
---------------------------
